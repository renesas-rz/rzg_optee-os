 ...
 * Version      : 1.0
 * Description  : SCE RSA Public API source file
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
/*******************************************************************************************************************//**
 * The R_SCE_RSASSA_PKCS1024_SignatureVerify() function verifies, in accordance with RSASSA-PKCS1-V1_5,
 * the signature text input to the first argument signature,
 * and the message text or hash value input to the second argument,
...
/*******************************************************************************************************************//**
 * The R_SCE_RSASSA_PKCS2048_SignatureVerify() function verifies, in accordance with RSASSA-PKCS1-V1_5,
 * the signature text input to the first argument signature,
 * and the message text or hash value input to the second argument,
 * message_hash, using the public wrapped key input to the third argument, wrapped_key. When a message is specified
 * in the second argument, message_hash->data_type, a hash value is calculated using the public wrapped key input to
...
/*******************************************************************************************************************//**
 * The R_SCE_RSASSA_PKCS4096_SignatureVerify() function verifies, in accordance with RSASSA-PKCS1-V1_5,
 * the signature text input to the first argument signature,
 * and the message text or hash value input to the second argument,
 * message_hash, using the public wrapped key input to the third argument, wrapped_key. When a message is specified
 * in the second argument, message_hash->data_type, a hash value is calculated using the public wrapped key input to
