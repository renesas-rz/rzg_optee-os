...
#ifndef _SPI_MULTI_REGS_H_
#define _SPI_MULTI_REGS_H_

#define SPIM_CMNCR					(0x00000000)	/* Common control register */
#define SPIM_SSLDR					(0x00000004)	/* SSL delay register */
#define SPIM_DRCR					(0x0000000C)	/* Data read control register */
#define SPIM_DRCMR					(0x00000010)	/* Data read command setting register */
#define SPIM_DREAR					(0x00000014)	/* Data read extended address setting register */
#define SPIM_DROPR					(0x00000018)	/* Data read option setting register */
#define SPIM_DRENR					(0x0000001C)	/* Data read enable setting register */
#define SPIM_SMCR					(0x00000020)	/* Manual mode control register */
#define SPIM_SMCMR					(0x00000024)	/* Manual mode command setting register */
#define SPIM_SMADR					(0x00000028)	/* Manual mode address setting register */
#define SPIM_SMOPR					(0x0000002C)	/* Manual mode option setting register */
#define SPIM_SMENR					(0x00000030)	/* Manual mode enable setting register */
#define SPIM_SMRDR0					(0x00000038)	/* Manual mode read data register 0 */
#define SPIM_SMRDR1					(0x0000003C)	/* Manual mode read data register 1 */
#define SPIM_SMWDR0					(0x00000040)	/* Manual mode write data register 0 */
#define SPIM_SMWDR1					(0x00000044)	/* Manual mode write data register 1 */
#define SPIM_CMNSR					(0x00000048)	/* Common status register */
#define SPIM_DRDMCR					(0x00000058)	/* Data read dummy cycle setting register */
#define SPIM_DRDRENR					(0x0000005C)	/* Data read DDR enable register */
#define SPIM_SMDMCR					(0x00000060)	/* Manual mode dummy cycle setting register */
#define SPIM_SMDRENR					(0x00000064)	/* Manual mode DDR enable register */
#define SPIM_PHYCNT					(0x0000007C)	/* PHY control register */
#define SPIM_PHYOFFSET1					(0x00000080)	/* PHY offset register 1 */
#define SPIM_PHYOFFSET2					(0x00000084)	/* PHY offset register 2 */
#define SPIM_PHYINT					(0x00000088)	/* PHY interrupt register */
#define SPIM_PHYADJ1					(0x00000070)	/* PHY adjustment register 1 */
#define SPIM_PHYADJ2					(0x00000074)	/* PHY adjustment register 2 */
#define SPIM_WBUF					(0x00010000)
...
#define PHYCNT_CAL_PERFORMED				(U(1) << 31)
#define PHYCNT_CAL_NOT_PERFORMED			(0 << 31)
...
extern vaddr_t spi_multi_base;

static inline void spi_io_write(uint32_t reg, uint32_t data)
{
	io_write32(spi_multi_base + reg, data);
}

static inline uint32_t spi_io_read(uint32_t reg)
{
	return io_read32(spi_multi_base + reg);
}

#endif /* _SPI_MULTI_REGS_H_ */
