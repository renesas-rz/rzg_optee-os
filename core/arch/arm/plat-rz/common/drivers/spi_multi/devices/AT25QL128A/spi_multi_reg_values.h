...
#define SMCMR_CMD_SECTOR_ERASE (0xD8)
...
#define STATUS_1_BUSY_BIT BIT(0)
#define STATUS_1_WEL_BIT BIT(1)
#define STATUS_1_BUSY BIT(0)
#define STATUS_1_WEL BIT(1)
