...
/* For AES */
#define RSIP_PRV_IV_TYPE_PLAIN_TEXT                          (BSWAP_32BIG_C(0U))
#define RSIP_PRV_IV_TYPE_ENCRYPED_TEXT                       (BSWAP_32BIG_C(1U))
...
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p48i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_ECB_ENCRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p48i_ecb_dec (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p48i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_ECB_DECRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p48i_cbc_enc (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p48i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_CBC_ENCRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p48i_cbc_dec (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p48i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_CBC_DECRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p48i_ctr (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p48i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_CTR_CRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p50i_ecb_enc (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p50i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_ECB_ENCRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p50i_ecb_dec (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p50i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_ECB_DECRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p50i_cbc_enc (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p50i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_CBC_ENCRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p50i_cbc_dec (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p50i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_CBC_DECRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p50i_ctr (const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p50i(&gs_cmd_aes_mode[RSIP_AES_MODE_EXTENDED_CTR_CRYPT], InData_KeyIndex, InData_IVType, InData_IV);
}
...
rsip_ret_t r_rsip_wrapper_p29i(const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p29i(InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p32i(const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p32i(InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p34i(const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p34i(InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p36i(const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    uint32_t InData_IVType[1] = {RSIP_PRV_IV_TYPE_PLAIN_TEXT};
    return r_rsip_p36i(InData_KeyIndex, InData_IVType, InData_IV);
}

rsip_ret_t r_rsip_wrapper_p29f(const uint32_t InData_Text[],
                               const uint32_t InData_DataALen[],
                               const uint32_t InData_TextLen[],
                               uint32_t       OutData_Text[],
                               uint32_t       OutData_DataT[])
{
    return r_rsip_p29f(InData_Text, InData_TextLen, InData_DataALen, OutData_Text, OutData_DataT);
}

rsip_ret_t r_rsip_wrapper_p34f(const uint32_t InData_Text[],
                               const uint32_t InData_DataALen[],
                               const uint32_t InData_TextLen[],
                               uint32_t       OutData_Text[],
                               uint32_t       OutData_DataT[])
{
    return r_rsip_p34f(InData_Text, InData_TextLen, InData_DataALen, OutData_Text, OutData_DataT);
}

rsip_ret_t r_rsip_wrapper_p32f(const uint32_t InData_Text[],
                               const uint32_t InData_DataT[],
                               const uint32_t InData_DataALen[],
                               const uint32_t InData_TextLen[],
                               const uint32_t InData_DataTLen[],
                               uint32_t       OutData_Text[])
{
    return r_rsip_p32f(InData_Text, InData_TextLen, InData_DataALen, InData_DataT, InData_DataTLen, OutData_Text);
}

rsip_ret_t r_rsip_wrapper_p36f(const uint32_t InData_Text[],
                               const uint32_t InData_DataT[],
                               const uint32_t InData_DataALen[],
                               const uint32_t InData_TextLen[],
                               const uint32_t InData_DataTLen[],
                               uint32_t       OutData_Text[])
{
    return r_rsip_p36f(InData_Text, InData_TextLen, InData_DataALen, InData_DataT, InData_DataTLen, OutData_Text);
}

rsip_ret_t r_rsip_wrapper_p71(const uint32_t InData_HashType[],
                              const uint32_t InData_Msg[],
                              const uint32_t InData_MsgLen[],
                              uint32_t       MAX_CNT,
                              uint32_t       OutData_MsgDigest[])
{
    rsip_ret_t rsip_ret = r_rsip_p70i(InData_HashType, InData_MsgLen);

    switch (rsip_ret)
    {
        case RSIP_RET_PASS:
        {
            rsip_ret = r_rsip_p70f(InData_Msg, MAX_CNT, OutData_MsgDigest);
            break;
        }
...
rsip_ret_t r_rsip_wrapper_p73(const uint32_t InData_KeyIndex[],
                              ...
                              uint32_t       OutData_State[])
{
    ...
    uint32_t InData_Cmd_Type[1];

    switch (InData_Cmd[0])
    {
        case RSIP_PRV_CMD_INIT_TO_FINAL:
        {
            rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA1], InData_MsgLen);
            if (RSIP_RET_PASS == rsip_ret)
            {
                InData_Cmd_Type[0] = RSIP_PRV_CMD_OUTPUT;
                rsip_ret = r_rsip_p75f(InData_Cmd_Type, InData_Msg, NULL, NULL, MAX_CNT, OutData_MAC);
            }
            break;
        }
        case RSIP_PRV_CMD_INIT_TO_COMP_FINAL:
        {
            rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA1], InData_MsgLen);
            if (RSIP_RET_PASS == rsip_ret)
            {
                InData_Cmd_Type[0] = RSIP_PRV_CMD_COMPARE;
                rsip_ret = r_rsip_p75f(InData_Cmd_Type, InData_Msg, InData_MAC, InData_length, MAX_CNT, NULL);
            }
            break;
        }
        case RSIP_PRV_CMD_INIT_TO_SUSPEND:
        {
            rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA1], InData_MsgLen);
            if (RSIP_RET_PASS == rsip_ret)
            {
                (void)r_rsip_p75u(InData_Msg, MAX_CNT);
                (void)r_rsip_p75s(OutData_State);
            }
            break;
        }
        case RSIP_PRV_CMD_RESUME_TO_SUSPEND:
        {
            rsip_ret = r_rsip_p75r(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA1], InData_State);
            if (RSIP_RET_PASS == rsip_ret)
            {
                (void)r_rsip_p75u(InData_Msg, MAX_CNT);
                (void)r_rsip_p75s(OutData_State);
        ...
        case RSIP_PRV_CMD_RESUME_TO_FINAL:
        {
            rsip_ret = r_rsip_p75r(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA1], InData_State);
            if (RSIP_RET_PASS == rsip_ret)
            {
        ...
        case RSIP_PRV_CMD_RESUME_TO_COMP_FINAL:
        {
            rsip_ret = r_rsip_p75r(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA1], InData_State);
            if (RSIP_RET_PASS == rsip_ret)
            {
...
rsip_ret_t r_rsip_wrapper_p76(const uint32_t InData_KeyIndex[],
                              const uint32_t InData_Cmd[],
                              const uint32_t InData_Msg[],
                              const uint32_t InData_MsgLen[],
                              const uint32_t InData_MAC[],
                              ...
                              uint32_t       OutData_State[])
{
    ...
    switch (InData_Cmd[0])
    {
        case RSIP_PRV_CMD_INIT_TO_FINAL:
        {
            rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA256], InData_MsgLen);
            if (RSIP_RET_PASS == rsip_ret)
            {
                InData_Cmd_Type[0] = RSIP_PRV_CMD_OUTPUT;
                rsip_ret = r_rsip_p75f(InData_Cmd_Type, InData_Msg, NULL, NULL, MAX_CNT, OutData_MAC);
        ...
        case RSIP_PRV_CMD_RESUME_TO_SUSPEND:
        {
            rsip_ret = r_rsip_p75r(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA256], InData_State);
            if (RSIP_RET_PASS == rsip_ret)
            {
                (void)r_rsip_p75u(InData_Msg, MAX_CNT);
                (void)r_rsip_p75s(OutData_State);
...
rsip_ret_t r_rsip_wrapper_pdc(const uint32_t InData_KeyIndex[],
                              const uint32_t InData_Cmd[],
                              const uint32_t InData_Msg[],
                              const uint32_t InData_MsgLen[],
                              const uint32_t InData_MAC[],
                              ...
                              uint32_t       OutData_State[])
{
    ...
    switch (InData_Cmd[0])
    {
        case RSIP_PRV_CMD_INIT_TO_FINAL:
        {
            rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA224], InData_MsgLen);
            if (RSIP_RET_PASS == rsip_ret)
            {
                InData_Cmd_Type[0] = RSIP_PRV_CMD_OUTPUT;
                rsip_ret = r_rsip_p75f(InData_Cmd_Type, InData_Msg, NULL, NULL, MAX_CNT, OutData_MAC);
        ...
        case RSIP_PRV_CMD_RESUME_TO_SUSPEND:
        {
            rsip_ret = r_rsip_p75r(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA224], InData_State);
            if (RSIP_RET_PASS == rsip_ret)
            {
                (void)r_rsip_p75u(InData_Msg, MAX_CNT);
                (void)r_rsip_p75s(OutData_State);
...
rsip_ret_t r_rsip_wrapper_p74(const uint32_t InData_KeyIndex[],
                              const uint32_t InData_Cmd[],
                              const uint32_t InData_Msg[],
                              const uint32_t InData_MsgLen[],
                              const uint32_t InData_MAC[],
                              ...
                              uint32_t       OutData_MAC[])
{
    rsip_ret_t rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA1], InData_MsgLen);
    if (RSIP_RET_PASS == rsip_ret)
    {
        rsip_ret = r_rsip_p75f(InData_Cmd, InData_Msg, InData_MAC, InData_length, MAX_CNT, OutData_MAC);
    }
    return rsip_ret;
}

rsip_ret_t r_rsip_wrapper_p77(const uint32_t InData_KeyIndex[],
                              const uint32_t InData_Cmd[],
                              const uint32_t InData_Msg[],
                              const uint32_t InData_MsgLen[],
                              const uint32_t InData_MAC[],
                              ...
                              uint32_t       OutData_MAC[])
{
    rsip_ret_t rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA256], InData_MsgLen);
    if (RSIP_RET_PASS == rsip_ret)
    {
        rsip_ret = r_rsip_p75f(InData_Cmd, InData_Msg, InData_MAC, InData_length, MAX_CNT, OutData_MAC);
    }
...
rsip_ret_t r_rsip_wrapper_pdd(const uint32_t InData_KeyIndex[],
                              const uint32_t InData_Cmd[],
                              const uint32_t InData_Msg[],
                              const uint32_t InData_MsgLen[],
                              const uint32_t InData_MAC[],
                              ...
                              uint32_t       OutData_MAC[])
{
    rsip_ret_t rsip_ret = r_rsip_p75i(InData_KeyIndex, &gs_cmd_hmac_hash_type[HMAC_HASH_TYPE_SHA224], InData_MsgLen);
    if (RSIP_RET_PASS == rsip_ret)
    {
        rsip_ret = r_rsip_p75f(InData_Cmd, InData_Msg, InData_MAC, InData_length, MAX_CNT, OutData_MAC);
    }
...
rsip_ret_t r_rsip_wrapper_p21(const uint32_t InData_HV[],
                              const uint32_t InData_IV[],
                              const uint32_t InData_Text[],
                              uint32_t       OutData_DataT[],
                              const uint32_t MAX_CNT)
{
    return r_rsip_p21(InData_HV, InData_IV, InData_Text, MAX_CNT, OutData_DataT);
}
