...
const rsip_func_subset_aes_t gp_func_aes[] =
{
    [RSIP_PRV_AES_REBASE(RSIP_KEY_TYPE_AES_128)] =
            ...
            .p_update = NULL,
            .p_final  = NULL
#endif /* RSIP_CFG_AES_128_ECB_CBC_CTR_ENABLE */
            },
    [RSIP_PRV_AES_REBASE(RSIP_KEY_TYPE_AES_256)] =
            ...
            .p_update = NULL,
            .p_final  = NULL
#endif /* RSIP_CFG_AES_256_ECB_CBC_CTR_ENABLE */
            },
};
...
const rsip_func_hmac_single_t gp_func_hmac_single[] =
{
    ...
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA1)] = r_rsip_wrapper_p74,
#else
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA1)] = NULL,
#endif
#if RSIP_CFG_HMAC_SHA224_ENABLE
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA224)] = r_rsip_wrapper_pdd,
#else
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA224)] = NULL,
#endif
#if RSIP_CFG_HMAC_SHA256_ENABLE
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA256)] = r_rsip_wrapper_p77,
#else
...
{
#if RSIP_CFG_HMAC_SHA1_ENABLE
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA1)] = r_rsip_wrapper_p73,
#else
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA1)] = NULL,
#endif
#if RSIP_CFG_HMAC_SHA224_ENABLE
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA224)] = r_rsip_wrapper_pdc,
#else
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA224)] = NULL,
#endif
#if RSIP_CFG_HMAC_SHA256_ENABLE
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA256)] = r_rsip_wrapper_p76,
#else
    [RSIP_PRV_HMAC_REBASE(RSIP_KEY_TYPE_HMAC_SHA256)] = NULL,
#endif
};
...
const rsip_func_ghash_t gp_func_ghash_compute = r_rsip_wrapper_p21;
                                           ...
                                           uint32_t         message_length)
{
    ...
    return r_rsip_wrapper_p71(InData_HashType, InData_Msg, InData_MsgLen, MAX_CNT, OutData_MsgDigest);
}
