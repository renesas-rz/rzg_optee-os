...
void r_rsip_func400(uint32_t ARG1[]);
void r_rsip_func420(void);
void r_rsip_func421(void);
void r_rsip_func422(uint32_t ARG1[], uint32_t ARG2);
...
void r_rsip_func435(uint32_t ARG1[], uint32_t ARG2[]);
void r_rsip_func436(uint32_t ARG1[]);
void r_rsip_func440(uint32_t ARG1[]);
void r_rsip_func441(uint32_t ARG1[]);
void r_rsip_func443(uint32_t ARG1[]);
...
rsip_ret_t r_rsip_p2a(const uint32_t MAX_CNT, uint32_t OutData_PubKeyIndex[], uint32_t OutData_PrivKeyIndex[]);
...
rsip_ret_t r_rsip_p2c(const uint32_t InData_CurveType[],
                      const uint32_t InData_Cmd[],
                      const uint32_t InData_IV[],
                      const uint32_t InData_InstData[],
                      uint32_t       OutData_KeyIndex[]);
rsip_ret_t r_rsip_p1e(const uint32_t InData_CurveType[],
                      const uint32_t InData_Cmd[],
                      const uint32_t InData_IV[],
                      const uint32_t InData_InstData[],
                      uint32_t       OutData_KeyIndex[]);
rsip_ret_t r_rsip_p0b(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
rsip_ret_t r_rsip_p0c(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
rsip_ret_t r_rsip_p0d(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
rsip_ret_t r_rsip_p0e(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
rsip_ret_t r_rsip_p38(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
rsip_ret_t r_rsip_p9e(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
rsip_ret_t r_rsip_p9d(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
rsip_ret_t r_rsip_p9f(const uint32_t InData_IV[], const uint32_t InData_InstData[], uint32_t OutData_KeyIndex[]);
...
/* AES-ECB/CBC/CTR */
rsip_ret_t r_rsip_p48i(const uint32_t InData_Cmd[], const uint32_t InData_KeyIndex[], const uint32_t InData_IVType[], const uint32_t InData_IV[]);
...
void       r_rsip_pb3u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
void       r_rsip_pb6u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
void       r_rsip_pb9u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
void       r_rsip_pc2u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
...
void       r_rsip_p29a(const uint32_t InData_DataA[], const uint32_t MAX_CNT);
void       r_rsip_p32a(const uint32_t InData_DataA[], const uint32_t MAX_CNT);
void       r_rsip_p34a(const uint32_t InData_DataA[], const uint32_t MAX_CNT);
void       r_rsip_p36a(const uint32_t InData_DataA[], const uint32_t MAX_CNT);
void       r_rsip_p29u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
void       r_rsip_p32u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
void       r_rsip_p34u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
void       r_rsip_p36u(const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT);
...
void       r_rsip_p41u(const uint32_t InData_Text[], const uint32_t MAX_CNT);
void       r_rsip_p44u(const uint32_t InData_Text[], const uint32_t MAX_CNT);
...
/* SHA */
rsip_ret_t r_rsip_p70f(const uint32_t InData_Msg[], const uint32_t MAX_CNT, uint32_t OutData_MsgDigest[]);
...
rsip_ret_t r_rsip_p70u(const uint32_t InData_Msg[], const uint32_t MAX_CNT);
...
rsip_ret_t r_rsip_p75u(const uint32_t InData_Msg[], const uint32_t MAX_CNT);
